...
python train.py --data_path "datasets/alpaca_cleaned_ja.json" --model_name "meta-llama/Llama-2-7b-hf"
# python train.py --data_path "datasets/alpaca_cleaned_ja.json" --model_name "meta-llama/Llama-2-13b-chat-hf"
# python train.py --data_path "datasets/alpaca_cleaned_ja.json" --model_name "meta-llama/Llama-2-13b-hf"
